...
def plot_covid_data(df, year, total_reported, hospital_admission, deceased, province, municipalities, months):
...
# Function to update plot based on widget values in UI
...
# === Toegevoegd: Ronald's update_plot ===
